...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <div className="relative rounded-3xl glass-panel p-8 sm:p-12 lg:p-16 border border-cyan-500/30 overflow-hidden shadow-2xl animate-fadeInUp">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 sm:space-y-8">
          ...
          {/* Main Title */}
          <h1 className="font-heading font-extrabold text-4xl sm:text-5xl lg:text-6xl text-white tracking-tight leading-[1.1] drop-shadow-[0_0_35px_rgba(0,240,255,0.3)]">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2 font-telemetry">
            <button
              ...
              className="py-4 px-8 rounded-2xl bg-gradient-to-r from-cyan-400 to-cyan-500 text-space-950 font-extrabold text-sm hover:opacity-95 flex items-center justify-center gap-3 shadow-[0_0_25px_rgba(0,240,255,0.5)] hover:scale-[1.02] transition-all duration-200"
            >
            ...
            <button
              ...
              className="py-4 px-8 rounded-2xl bg-space-900/90 text-cyan-300 border border-cyan-500/40 hover:border-cyan-400 font-extrabold text-sm flex items-center justify-center gap-3 hover:bg-space-850 transition-all duration-200"
            >
              <Orbit className="w-5 h-5 text-cyan-400 animate-orbit-rotate" />
              <span>VIEW TELEMETRY</span>
            </button>
          </div>

          {/* Metrics summary footnote */}
        ...
        <div className="lg:col-span-5 flex items-center justify-center">
          <div className="relative w-full max-w-sm aspect-square rounded-3xl bg-space-900/80 border border-cyan-500/40 p-6 flex flex-col items-center justify-center text-center shadow-[0_0_50px_rgba(0,240,255,0.2)]">
            <div className="w-24 h-24 rounded-3xl bg-cyan-950/80 border border-cyan-400/60 flex items-center justify-center shadow-[0_0_30px_rgba(0,240,255,0.4)] mb-6">
